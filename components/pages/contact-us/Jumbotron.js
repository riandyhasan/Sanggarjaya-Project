    ...
    <Flex
      ...
      <Flex flexDir='column' gridGap='2rem' alignItems='center' color='white'>
        ...
        <Text
          ...
          textAlign='center'
          maxW={{ base: '100%', md: '55%' }}>
          PT. Sanggar Jaya Abadi (SJA) providing any information needed through various communication channels. For any
          questions relating to PT. Sanggar Jaya Abadi (SJA), please contact us.{' '}
        </Text>
      </Flex>
    </Flex>
  );
