...
export default function Jumbotron({ type, setType }) {
  return (
    <Flex
      ...
      py='1.5rem'
      color='white'>
      <Flex flexDir='column' gridGap='2rem' alignItems='center' w='100%' px='3rem'>
        ...
        <Grid display={{ base: 'none', md: 'grid' }} gridTemplateColumns='repeat(3, 1fr)' gap={10}>
          ...
          <GridItem>
            <Box
              ...
              py='0.6rem'
              px='1.2rem'
              bg={type == 'Electrical & Utility Pole' ? 'primary.orange' : 'primary.grey'}
        ...
        <Grid display={{ base: 'none', md: 'grid' }} gridTemplateColumns='repeat(2, 1fr)' gap={10}>
          ...
          <GridItem>
            <Box
              ...
              py='0.6rem'
              px='1.2rem'
              bg={type == 'Custom Mount Antena' ? 'primary.orange' : 'primary.grey'}
        ...
        <Box w='100%' display={{ base: 'block', md: 'none' }}>
          <Select
            ...
            fontSize='1.2em'
            w='100%'>
            <option value='Our Products' style={{ color: '#353535' }}>
              All Products
            </option>
            <option value='Electrical & Utility Pole' style={{ color: '#353535' }}>
              Electrical & Utility Pole
            </option>
            <option value='Light Pole' style={{ color: '#353535' }}>
              Light Pole
            </option>
            <option value='Monopole Tower' style={{ color: '#353535' }}>
              Monopole Tower
            </option>
            <option value='Custom Mount Antena' style={{ color: '#353535' }}>
              Custom Mount Antena
            </option>
          </Select>
        </Box>
