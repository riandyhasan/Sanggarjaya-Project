...
export default function OurCustomers(){
    ...
    return(
        <Flex w="100%" flexDir="column" alignItems="center" py="3rem" bg="white" px="2rem" gridGap="2rem">
            <Heading color="primary.black" borderBottom="5px solid #077F46">Our Customers</Heading>
